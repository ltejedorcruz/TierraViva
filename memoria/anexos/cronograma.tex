...
Este anexo recoge la planificación temporal seguida durante el desarrollo de TierraViva, desde el inicio del Trabajo de Fin de Grado a finales de agosto de 2025 hasta la entrega y defensa previstas en julio de 2026. El cronograma se plantea como la reconstrucción ordenada del trabajo real realizado: definición inicial, revisión tecnológica, primeros prototipos, reajuste de arquitectura, implementación \textit{hardware} y \textit{software}, validación funcional, prueba en Agrolab Móstoles y redacción progresiva de la memoria.
...
\hline
Ajustes eléctricos, condensador de \(2200~\mu\mathrm{F}\) y diodo de protección &  &  &  &  &  &  &  &  &  &  & X &  \\
\hline
...
La Tabla~\ref{cuadro:hitos_cronograma} identifica los hitos más relevantes del proyecto. Estos hitos permiten entender la evolución técnica de TierraViva como una construcción progresiva, con reajustes derivados de las pruebas, la integración de componentes y la evolución de la arquitectura.
...
El desarrollo incluyó varios reajustes relevantes. Estos cambios se recogen como decisiones técnicas necesarias para alcanzar una solución más coherente con el objetivo final del TFG.
...
\hline
Separación entre publicación y control & ThingSpeak podía fallar temporalmente o no responder de forma inmediata. & La lógica local de riego permanece en la estación y mantiene un comportamiento seguro ante pérdidas temporales de publicación. \\
\hline
...
\hline
Incorporación de estación B & Se quería demostrar la capacidad multiestación de la arquitectura. & Se montó y probó una segunda estación, con configuración diferenciada y validación en Agrolab. \\
\hline
Ajustes en bloque de bomba y alimentación & La bomba introduce perturbaciones y exige una alimentación más robusta que la sensórica. & Se reforzó la documentación eléctrica y se incorporaron un condensador de \(2200~\mu\mathrm{F}\) y un diodo asociado a la rama de la bomba. \\
\hline
...
Estas dependencias muestran que el proyecto se desarrolló como una integración progresiva. Cada bloque condicionó al siguiente y obligó a revisar decisiones a medida que el prototipo pasaba de una idea inicial a un sistema físico funcional.
...
Esta forma de trabajo permitió que la documentación recogiera la evolución real del proyecto: decisiones descartadas, problemas encontrados, reajustes de arquitectura, validación por bloques, evidencias de funcionamiento y limitaciones detectadas.
...
La planificación seguida muestra que TierraViva evolucionó mediante pruebas, correcciones y decisiones técnicas justificadas, hasta alcanzar un prototipo funcional de extremo a extremo.