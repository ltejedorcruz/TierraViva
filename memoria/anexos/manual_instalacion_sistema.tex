...
Por tanto, antes de arrancar el sistema debe copiarse el \textit{dashboard} al directorio \texttt{frontend/}:
...
Tras la instalación, se recomienda repetir la copia del \textit{dashboard} para asegurar que el \textit{frontend} servido por la API está actualizado:
...
\hline
El \textit{dashboard} no carga & No existe \texttt{frontend/index.html}. & Ejecutar \texttt{rsync -a dashboard/ frontend/}. \\
\hline
