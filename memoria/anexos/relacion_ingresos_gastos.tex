...
La estimación no pretende equivaler a una dedicación profesional registrada hora a hora, sino valorar de forma razonable el esfuerzo técnico y documental asociado al desarrollo del prototipo. Incluye análisis, diseño, montaje, programación, integración, pruebas, validación en Agrolab Móstoles, elaboración de evidencias, redacción de capítulos y preparación de anexos.
...
\hline
\rowcolor{gray!15}
\textbf{Coste total valorado con margen de reproducción} & \textbf{11242.05 \euro{}} \\
\hline
\end{tabular}
