...
\hline
Desarrollo del \textit{firmware} de estación & 110 h & 15 \euro{}/h & 1650.00 \euro{} \\
\hline
Integración con ThingSpeak & 60 h & 15 \euro{}/h & 900.00 \euro{} \\
\hline
Desarrollo en Raspberry Pi, API, SQLite y \textit{dashboard} & 115 h & 15 \euro{}/h & 1725.00 \euro{} \\
\hline
...
La principal diferencia aparece al valorar el tiempo de desarrollo. Aunque el desembolso material es reducido, el verdadero valor del proyecto está en la integración de componentes, la programación del \textit{firmware}, la comunicación LTE, la conexión con ThingSpeak, el \textit{backend} en Raspberry Pi, la API, el \textit{dashboard}, las pruebas y la documentación técnica.
