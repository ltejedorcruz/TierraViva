...
\hline
D03 & Usar Raspberry Pi como nodo local de supervisión. & La Raspberry Pi aporta capacidad para ejecutar ingesta, SQLite, API y \textit{dashboard}, sin necesidad de situarla físicamente en cada estación. & Se separa la estación de campo del sistema de supervisión y visualización. \\
\hline
...
\hline
D05 & Utilizar ThingSpeak como capa intermedia de telemetría. & Permite recibir datos IoT y consultarlos posteriormente sin desarrollar una plataforma \textit{cloud} propia. & Reduce tiempo de desarrollo y centra el esfuerzo en integración, validación y visualización. \\
\hline
...
\hline
D07 & No implementar control remoto descendente en la versión actual. & Añadir órdenes remotas implica seguridad, sincronización, gestión de comandos, latencia y riesgo de actuación no deseada. & El \textit{dashboard} se limita a supervisión; no envía órdenes de riego a la estación. \\
\hline
...
\hline
D10 & Crear un \textit{dashboard} web local. & Permite consultar el sistema desde un navegador sin desarrollar una aplicación móvil específica. & Mejora la usabilidad y permite visualizar lecturas, estados, gráficas e histórico. \\
\hline
...
\hline
Aplicación móvil propia & Aumenta el alcance sin ser necesaria para validar la arquitectura principal. & Se implementa un \textit{dashboard} web accesible desde navegador. \\
\hline
