...
\hline
\texttt{A} & \texttt{THINGSPEAK\_CHANNEL\_A} & Canal principal de la primera estación remota. \\
\hline
\texttt{B} & \texttt{THINGSPEAK\_CHANNEL\_B} & Canal previsto para una segunda estación o ampliación del sistema. \\
\hline
\end{tabular}
