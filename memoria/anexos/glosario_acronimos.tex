...
El glosario no sustituye a los anexos técnicos específicos. La estructura de campos de ThingSpeak se documenta en el Anexo \ref{anexo:estructura_thingspeak_estados}; la referencia de endpoints, en el Anexo \ref{anexo:manual_api}; y el uso del dashboard, en el Anexo \ref{anexo:manual_usuario}.
...
\begin{description}
    ...
    Envío de órdenes desde una plataforma o dashboard hacia una estación remota. Se descarta en la versión actual para reducir complejidad y evitar actuaciones no deseadas.
    ...
    Nodo físico instalado en campo o entorno de pruebas. Está formado por Arduino UNO, sensores, módulo LTE, relé, alimentación y sistema de riego.
    ...
    \item[Frontend]
    Parte visual de una aplicación web. En TierraViva corresponde al dashboard desarrollado con HTML, CSS y JavaScript.

    \item[Frescura de datos]
    Clasificación de la antigüedad de la última lectura. La API y el dashboard la utilizan para diferenciar datos recientes, antiguos u offline.
    ...
    \item[LM2596]
    Regulador DC-DC utilizado para convertir una tensión de entrada superior, como 12 V, en una salida regulada de 5 V.
    ...
    \item[Raspberry Pi]
    Ordenador de placa reducida utilizado como nodo local de supervisión, almacenamiento, API y dashboard.
    ...
    \item[ThingsBoard]
    Plataforma IoT de código abierto orientada a la gestión de dispositivos, telemetría, reglas y dashboards. Se consideró como alternativa más completa, aunque se descartó para el alcance actual por requerir mayor configuración e infraestructura.
    ...
    Estrategia de pruebas por bloques. Permite comprobar sensores, comunicaciones, almacenamiento, API, dashboard y actuación antes de validar el sistema completo.
...
\hline
CSS & \textit{Cascading Style Sheets} & Hojas de estilo del dashboard web. \\
\hline
...
\hline
HTML & \textit{HyperText Markup Language} & Estructura del dashboard web. \\
\hline
...
\hline
IDE & \textit{Integrated Development Environment} & Entorno utilizado para programar y cargar el firmware en Arduino. \\
\hline
...
\hline
IP & \textit{Internet Protocol} & Dirección utilizada para acceder al dashboard o a la API de la Raspberry Pi. \\
\hline
...
\hline
URL & \textit{Uniform Resource Locator} & Dirección usada para acceder a ThingSpeak, API o dashboard. \\
\hline
...
Estación A & Primera estación remota del prototipo. Publica datos en su canal ThingSpeak correspondiente. \\
\hline
Estación B & Segunda estación prevista para ampliación o validación multiestación. Debe disponer de identificador y canal propios. \\
\hline
...
\hline
\texttt{system\_event} & Código de evento que informa sobre reposo, riego, error, modo seguro o cooldown. \\
\hline
...
\hline
\texttt{THINGSPEAK\_API\_KEY} & Clave de escritura utilizada por el firmware de estación. Debe mantenerse fuera del repositorio público. \\
\hline
...
\hline
\texttt{WEB\_REFRESH\_SECONDS} & Intervalo recomendado de actualización del dashboard. \\
\hline
...
\hline
\texttt{429} & \texttt{system\_event} / \texttt{debug\_code} & Riego bloqueado por cooldown. \\
\hline
\end{tabular}
