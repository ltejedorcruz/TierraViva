...
\hline
LED & \textit{Light Emitting Diode} & Indicador luminoso empleado en pruebas o diagnóstico. \\
\hline
...
\hline
\texttt{valve\_events} & Tabla prevista para registrar eventos de actuación o válvula. \\
\hline
...
Este glosario permite mantener una nomenclatura común entre la memoria, el firmware, ThingSpeak, SQLite, la API y el dashboard. Su función es servir como consulta rápida: las definiciones detalladas, la instalación, los endpoints y la interpretación de usuario se mantienen en sus anexos correspondientes.