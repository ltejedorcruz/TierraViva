...
\begin{description}
    ...
    \item[Condensador]
    Componente electrónico utilizado para almacenar carga eléctrica de forma temporal y ayudar a estabilizar tensiones o filtrar variaciones rápidas. En TierraViva se emplea como elemento auxiliar de estabilización eléctrica.

    \item[Diodo]
    Componente electrónico que permite el paso de corriente preferentemente en un sentido. En TierraViva se utiliza como elemento auxiliar de protección eléctrica asociado a la rama de actuación de la bomba.
