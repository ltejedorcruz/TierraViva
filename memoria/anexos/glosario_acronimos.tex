...
\begin{description}
    ...
    \item[Estado seguro]
    Condición conservadora del sistema en la que la actuación física se mantiene desactivada o limitada para evitar riesgos. En TierraViva implica relé apagado, riego no repetido y bomba activa solo durante intervalos temporizados.
    ...
    \item[Latencia]
    Tiempo de retardo entre el envío de una orden, dato o petición y la obtención de una respuesta o efecto observable. En TierraViva se menciona al descartar el control remoto descendente de riego, ya que una actuación sobre agua no debería depender de retrasos de comunicación no controlados.
    ...
    Versión funcional desarrollada dentro del alcance de un Trabajo de Fin de Grado. En TierraViva permite validar arquitectura, sensorización, comunicación, almacenamiento, visualización y actuación, sin presentarse como producto comercial final.
    ...
    Riesgo que permanece tras aplicar medidas de mitigación. En TierraViva se utiliza para delimitar los aspectos que siguen presentes por tratarse de un prototipo académico y no de un producto industrial final.
...
\hline
PIN & \textit{Personal Identification Number} & Código de identificación asociado a la tarjeta SIM. En TierraViva se comprueba que no bloquee el registro del módem LTE en la red móvil. \\
\hline
