...
\begin{description}
    ...
    \item[Credenciales]
    Datos de autenticación, como claves de lectura o escritura, utilizados para acceder a servicios o canales de comunicación. En TierraViva deben protegerse especialmente las claves asociadas a ThingSpeak y a la API.
