...
El glosario no sustituye a los anexos técnicos específicos. La estructura de campos de ThingSpeak se documenta en el Anexo \ref{anexo:estructura_thingspeak_estados}; la referencia de endpoints, en el Anexo \ref{anexo:manual_api}; y el uso del \textit{dashboard}, en el Anexo \ref{anexo:manual_usuario}.
