...
\vspace{0.1cm}
\begin{itemize}
    \item \textbf{F1. Arquitectura modular:} separación clara entre estación de campo, plataforma IoT, almacenamiento local, API y dashboard.
...
\begin{itemize}
    ...
    \item \textbf{D2. Robustez limitada:} el montaje no alcanza todavía el nivel mecánico, eléctrico y ambiental de un producto industrial, pero no es el objetivo de este prototipo académico. Se podría tomar como una continuación futura.
...
\begin{itemize}
    ...
    \item \textbf{A6. Seguridad y credenciales:} una implantación real requeriría reforzar la protección de claves, endpoints y canales.
\end{itemize}
\vspace{0.1cm}
\end{minipage}
\\
...
El análisis muestra que TierraViva tiene una base técnica sólida para un prototipo académico de riego inteligente. Sus principales fortalezas se encuentran en la integración de varias capas: estación embebida, comunicación LTE, plataforma IoT, almacenamiento local, API y dashboard.
...
El análisis DAFO confirma que TierraViva es un proyecto viable, estable, funcional y coherente. Su valor principal reside en integrar hardware, comunicaciones y software para resolver un problema real: la supervisión y automatización del riego en un entorno desatendido.
