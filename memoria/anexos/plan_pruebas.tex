...
\hline
P13 & \textit{Cooldown} entre riegos & Forzar dos decisiones de riego consecutivas. & La segunda activación se bloquea si no ha pasado el tiempo mínimo. \\
\hline
...
\hline
P16 & Integración completa & Ejecutar estación, ThingSpeak, Raspberry, API, \textit{dashboard} y actuación. & El flujo completo funciona de extremo a extremo. \\
\hline
...
\textbf{Evidencias.} Vídeo de funcionamiento disponible en el repositorio del proyecto [url].
