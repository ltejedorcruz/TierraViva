...
\hline
P17 & Prueba funcional en Agrolab Móstoles & Instalar el prototipo en Agrolab, ejecutar la estación, comprobar telemetría, dashboard y actuación controlada, y registrar foto/vídeo como evidencia. & El sistema funciona en entorno real de cultivo y mantiene actuación segura. \\
\hline
\end{tabular}
...
\textbf{Objetivo.} Validar el comportamiento del prototipo TierraViva en un entorno real de cultivo, comprobando adquisición de datos, publicación de telemetría, supervisión desde Raspberry Pi, visualización en dashboard y actuación controlada del riego.
...
\begin{enumerate}
    ...
    \item iniciar el firmware de estación y comprobar la lectura de sensores;
    \item publicar telemetría en el canal ThingSpeak correspondiente;
    \item comprobar la ingesta desde Raspberry Pi, el almacenamiento local y la visualización en dashboard;
