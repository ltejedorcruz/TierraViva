...
El relé se fuerza a estado apagado durante el arranque y la actuación se limita temporalmente mediante firmware. Esta decisión reduce el riesgo de activaciones no deseadas.
...
La respuesta segura ante lectura inválida, error o cooldown es mantener la bomba apagada.
...
\hline
4 & A7670E-LASA & Publica telemetría y estado en ThingSpeak mediante LTE. \\
\hline
...
\hline
7 & API & Expone los datos almacenados mediante endpoints HTTP. \\
\hline
8 & Dashboard & Muestra lecturas, estados, gráficas e histórico al usuario. \\
\hline
\end{tabular}
...
\hline
Relé y bomba & Ejecutar físicamente el riego cuando el firmware lo permite. & Sí \\
\hline
A7670E-LASA & Enviar telemetría mediante LTE. & No \\
\hline
ThingSpeak & Recibir y conservar lecturas publicadas por las estaciones. & No \\
\hline
Raspberry Pi & Ingerir, almacenar y servir datos al dashboard. & No \\
\hline
API FastAPI & Exponer lecturas, histórico, estadísticas y estado. & No \\
\hline
Dashboard & Presentar información al usuario. & No \\
\hline
\end{tabular}
