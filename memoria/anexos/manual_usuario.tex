...
\begin{figure}[H]
    ...
    \caption{Vista general del \textit{dashboard} web de TierraViva.}
...
\begin{figure}[H]
    ...
    \caption{Gráficas de evolución reciente del \textit{dashboard}, incluyendo variables ambientales, humedad del suelo y códigos de estado publicados por la estación.}
...
\begin{figure}[H]
    ...
    \caption{Resumen histórico del \textit{dashboard}, con número de muestras, ventana temporal y valores agregados de las variables medidas.}
...
\begin{figure}[H]
    ...
    \caption{Tabla de últimas lecturas almacenadas y mostradas por el \textit{dashboard}.}
