...
\hline
Montaje y protección & Protoboard, cableado, resistencias, condensadores, diodo, aislamiento y soporte físico & Conexionado, adaptación básica de señales, pruebas de integración y protección mecánica inicial. \\
\hline
\end{tabular}
...
\label{sec:uso_ia_generativa_tfg}

Durante la elaboración de esta memoria se han utilizado herramientas de inteligencia artificial generativa como apoyo auxiliar en tareas de redacción, organización de contenidos, búsqueda de información y generación de material visual explicativo. Este uso se ha realizado siempre a partir de trabajo previo de la autora: borradores propios, notas tomadas durante la programación, incidencias encontradas, pruebas realizadas, decisiones de diseño, cambios de arquitectura y resultados obtenidos durante el desarrollo del prototipo.

En la parte escrita, estas herramientas se han empleado para mejorar la claridad de algunos apartados, reorganizar explicaciones que ya estaban documentadas, detectar repeticiones, proponer una redacción más académica y ayudar a formular búsquedas de información técnica de forma más precisa. La selección de contenidos, la interpretación de la información, las decisiones técnicas y la versión final del texto han sido revisadas y asumidas por la autora.

En cuanto al material gráfico, algunas figuras conceptuales o de apoyo visual se han generado con inteligencia artificial a partir de párrafos ya redactados de la memoria y de instrucciones concretas proporcionadas por la autora. Su finalidad ha sido transformar explicaciones textuales propias en representaciones visuales más comprensibles, como esquemas conceptuales, diagramas visuales o imágenes de apoyo. Estas figuras no sustituyen a las evidencias reales del proyecto: las capturas de pantalla, fotografías del prototipo, registros de monitor serie, resultados de pruebas y demás evidencias técnicas proceden directamente del trabajo desarrollado.

Por tanto, el uso de inteligencia artificial generativa en este TFG debe entenderse como una herramienta de apoyo formal y visual para mejorar la comunicación del trabajo realizado. El diseño del sistema, el montaje del prototipo, la programación del \textit{firmware}, la integración con ThingSpeak, el desarrollo en Raspberry Pi, la API, el \textit{dashboard}, las pruebas, la validación funcional y las conclusiones técnicas corresponden al desarrollo realizado por la autora.
