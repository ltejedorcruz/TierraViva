...
\hline
\rowcolor{gray!20}
\textbf{Interviniente} & \textbf{Rol} & \textbf{Contribución principal} \\
\hline
Lucía Tejedor de la Cruz & Autora y desarrolladora del TFG & Definición del alcance, diseño de arquitectura, selección de componentes, montaje del prototipo, desarrollo de firmware, backend, API, dashboard, pruebas y redacción de la memoria. \\
\hline
...
\hline
Personal del Agrolab de Móstoles & Apoyo de entorno & Colaboración indirecta en el acceso al entorno de pruebas y apoyo contextual para posibles ensayos en condiciones próximas a un escenario real. \\
\hline
\end{tabular}
...
\hline
\rowcolor{gray!20}
\textbf{Responsabilidad} & \textbf{Responsable principal} & \textbf{Apoyo o supervisión} \\
\hline
...
\hline
Desarrollo de firmware Arduino & Autora & Javier Simó \\
\hline
Desarrollo en Raspberry Pi, API y dashboard & Autora & Javier Simó \\
\hline
...
Esta tabla no representa una distribución porcentual de autoría, sino la organización del trabajo y los apoyos disponibles durante el desarrollo.

\section{Recursos hardware}

Los recursos hardware se agrupan por función dentro del sistema. No se detallan aquí referencias comerciales ni precios, ya que esa información se encuentra en el Anexo \ref{anexo:materiales}.
...
\hline
\rowcolor{gray!20}
\textbf{Bloque} & \textbf{Recursos principales} & \textbf{Función dentro del proyecto} \\
\hline
Estación remota & Arduino UNO, sensores BME280, BH1750 y sensor capacitivo de humedad del suelo & Medición de variables ambientales y del sustrato, validación local de lecturas y ejecución del firmware de estación. \\
\hline
...
\hline
Actuación de riego & Módulo relé y bomba de agua de 12 V & Activación física del riego cuando el firmware lo permite, con apagado temporizado. \\
\hline
...
\hline
Nodo de supervisión & Raspberry Pi, tarjeta microSD y fuente USB-C & Ejecución de ingesta, base de datos SQLite, API FastAPI y dashboard web. \\
\hline
...
La separación por bloques permite distinguir entre recursos propios de cada estación y recursos compartidos. La Raspberry Pi, por ejemplo, actúa como nodo de supervisión y no tendría que duplicarse necesariamente por cada estación adicional.
...
\hline
\rowcolor{gray!20}
\textbf{Recurso} & \textbf{Categoría} & \textbf{Uso en TierraViva} \\
\hline
Arduino IDE & Desarrollo embebido & Programación y carga del firmware en Arduino UNO. \\
\hline
C/C++ & Firmware & Lectura de sensores, comunicación con el módem, decisión local de riego y control del relé. \\
\hline
Python & Backend local & Ingesta de datos, persistencia, lógica auxiliar y API. \\
\hline
...
\hline
HTML, CSS y JavaScript & Frontend web & Construcción del dashboard de visualización. \\
\hline
Bash & Automatización & Instalación, arranque, parada, estado y consulta de logs mediante \texttt{tierraviva.sh}. \\
\hline
...
\hline
\rowcolor{gray!20}
\textbf{Servicio} & \textbf{Tipo} & \textbf{Función en el proyecto} \\
\hline
...
\hline
Red móvil LTE/4G & Infraestructura de comunicación & Conectividad de las estaciones remotas en ubicaciones sin dependencia directa de una red WiFi local. \\
\hline
...
\hline
\rowcolor{gray!20}
\textbf{Recurso experimental} & \textbf{Uso previsto} \\
\hline
...
\hline
\rowcolor{gray!20}
\textbf{Recurso documental} & \textbf{Uso en el proyecto} \\
\hline
...
\hline
Notas de pruebas, capturas y logs & Evidencias de funcionamiento, depuración y validación progresiva del prototipo. \\
\hline
\end{tabular}
...
La Tabla \ref{tab:recursos_por_fase_resumidos} relaciona los recursos anteriores con las fases generales del proyecto. No se reproduce aquí el cronograma completo, sino una visión de qué recursos resultan críticos en cada bloque de trabajo.
...
\hline
\rowcolor{gray!20}
\textbf{Fase} & \textbf{Recursos principales} & \textbf{Resultado esperado} \\
\hline
...
\hline
Desarrollo software & Arduino IDE, Python, SQLite, FastAPI, JavaScript, GitHub y Bash & Firmware, ingestor, base de datos, API, dashboard y script de gestión. \\
\hline
Integración y comunicación & ThingSpeak, red LTE, Raspberry Pi y configuración local & Flujo de datos desde estación hasta almacenamiento local y dashboard. \\
\hline
Validación experimental & Entorno de prueba, Agrolab o maceta, instrumental básico, logs y capturas & Evidencias de funcionamiento, incidencias detectadas y ajustes realizados. \\
\hline
...
No todos los recursos crecen de la misma forma si el sistema se amplía. Algunos deben duplicarse por estación, mientras que otros pueden compartirse.
...
\hline
\rowcolor{gray!20}
\textbf{Recurso} & \textbf{Tipo} & \textbf{Criterio de escalado} \\
\hline
Sensores, Arduino, módem LTE, relé y alimentación de estación & Por estación & Deben añadirse para cada nuevo nodo físico. \\
\hline
Canal ThingSpeak y claves asociadas & Por estación & Se recomienda un canal independiente para no mezclar datos. \\
\hline
Raspberry Pi & Compartido & Puede supervisar varias estaciones si el volumen de datos es moderado. \\
\hline
API, base de datos y dashboard & Compartidos & Admiten varias estaciones mediante identificadores y configuración. \\
\hline
Documentación, scripts y repositorio & Compartidos & Se reutilizan para reproducir o ampliar el sistema. \\
\hline
...
Esta distinción resulta relevante porque el coste incremental de añadir estaciones no es igual al coste total del prototipo inicial. Parte de la infraestructura, como la Raspberry Pi, la API, la base de datos y el dashboard, puede reutilizarse.

\section{Conclusión}

El desarrollo de TierraViva ha requerido recursos de naturaleza diversa: personas, componentes electrónicos, herramientas de programación, servicios de comunicación, entorno experimental y documentación técnica. La organización de estos recursos permite entender el proyecto como un sistema integrado, no como una simple suma de componentes.
