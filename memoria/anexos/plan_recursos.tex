...
Esta distinción resulta relevante porque el coste incremental de añadir estaciones no es igual al coste total del prototipo inicial. Parte de la infraestructura, como la Raspberry Pi, la API, la base de datos y el \textit{dashboard}, puede reutilizarse.
