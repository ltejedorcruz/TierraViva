...
\hline
\textit{Dashboard} web & Visualización de medidas, histórico, estado del relé y estado de las estaciones. & Permite supervisar el prototipo sin acceder a la consola ni realizar consultas SQL (\textit{Structured Query Language}). \\
\hline
\end{tabular}
