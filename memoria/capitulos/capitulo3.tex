...
\begin{figure}[H]
    ...
    \caption{Relación entre los requisitos funcionales y el ciclo completo de funcionamiento del sistema. TierraViva debe medir, publicar telemetría, registrar histórico, visualizar el estado, decidir localmente y actuar sobre el riego de forma segura. Elaboración propia.}
...
\begin{figure}[H]
    ...
    \caption{Requisitos no funcionales considerados en el diseño del prototipo. Estos criterios permiten evaluar la calidad técnica del sistema más allá de las funciones implementadas. Elaboración propia.}
...
\begin{figure}[H]
    ...
    \caption{Especificaciones temporales y operativas iniciales del sistema. Elaboración propia.}
...
\begin{figure}[H]
    ...
    \caption{Variables seleccionadas para la monitorización de TierraViva. La humedad del suelo se utiliza como variable principal para la decisión local de riego, mientras que temperatura, humedad relativa, presión y luminosidad aportan contexto ambiental. Elaboración propia.}
...
\begin{figure}[H]
    ...
    \caption{Separación de responsabilidades entre Arduino UNO y Raspberry Pi 5. Elaboración propia.}
...
\begin{figure}[H]
    ...
    \caption{Uso de ThingSpeak como \textit{broker} de telemetría entre estaciones remotas y sistema de supervisión. La plataforma organiza la telemetría y los estados por canales y campos, permitiendo su consulta posterior desde Raspberry Pi. Elaboración propia.}
...
\begin{figure}[H]
    ...
    \caption{Arquitectura software de supervisión en Raspberry Pi. La información publicada en la nube se consulta, valida, almacena en SQLite, expone mediante FastAPI y se presenta en el \textit{dashboard} web. Elaboración propia.}
...
\begin{figure}[H]
  ...
  \caption{Arquitectura general planteada para TierraViva. Elaboración propia.}
