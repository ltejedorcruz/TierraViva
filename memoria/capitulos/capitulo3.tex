...
\hline
ET-05 & Tiempo máximo de bomba activa & Limitado en pruebas; ajustable en \textit{firmware} & La activación de la bomba se limita a intervalos breves durante la validación del prototipo. Este valor no se plantea como una duración agronómica definitiva, sino como una medida de seguridad para evitar riego indefinido, sobrecarga del actuador o consumo innecesario de agua ante errores de control. En una instalación real debería ajustarse a partir del caudal de la bomba, el volumen de agua deseado, el tipo de sustrato y la respuesta observada de la humedad del suelo. \\
\hline
...
\hline
\textit{Dashboard} web & Visualización de medidas, histórico, estado del relé y estado de las estaciones. & Permite supervisar el prototipo sin acceder a consola o consultas SQL. \\
\hline
\end{tabular}
