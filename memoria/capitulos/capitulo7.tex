...
\begin{figure}[H]
    ...
    \caption{Montaje físico utilizado para la validación de las estaciones remotas. Fotografía propia.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.82\textwidth]{figs/prueba_agrolab_mostoles.jpg}
    \caption[Prueba funcional de TierraViva en Agrolab Móstoles]{Prueba funcional de TierraViva en Agrolab Móstoles. Vídeo de la prueba disponible en: \url{https://youtu.be/oCnP5rSnTMI}. Elaboración propia.}
