...
Estas pruebas demuestran que el prototipo incorpora una lógica de actuación prudente. TierraViva no ejecuta el riego por una orden remota desde la nube, sino por decisión local de la estación. Además, la actuación está limitada en el tiempo y protegida por cooldown, validación de sensores y estado seguro por defecto. El análisis completo de riesgos asociados se recoge en el Anexo~\ref{anexo:gestion_riesgos}.
