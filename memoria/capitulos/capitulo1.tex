...
\begin{figure}[H]
    ...
    \caption{Evolución conceptual desde un riego basado en rutinas fijas hacia un riego apoyado en medidas reales del entorno. Elaboración propia, véase Anexo~\ref{sec:uso_ia_generativa_tfg}.}
...
\begin{wrapfigure}{r}{0.32\textwidth}
    \vspace{-12pt}
    \centering
    \includegraphics[width=0.30\textwidth]{figs/TierraViva_Logo.jpeg}
    \caption{Identidad visual de TierraViva. Elaboración propia, véase Anexo~\ref{sec:uso_ia_generativa_tfg}.}
    \label{fig:logo_tierraviva}
    \vspace{-8pt}
\end{wrapfigure}

Dentro de este contexto surge TierraViva, un proyecto orientado al diseño de un prototipo de Internet de las Cosas (IoT, del inglés \textit{Internet of Things}) para monitorización y control de riego. El objetivo principal es desarrollar una solución funcional de riego inteligente que integre sensorización ambiental, comunicación móvil, supervisión web y actuación local para abordar un problema real desde una perspectiva técnica, estable y sostenible. El proyecto parte de una idea sencilla, medir el estado del entorno y actuar sobre el riego cuando sea necesario, pero implica varias capas técnicas: adquisición de datos mediante sensores, comunicación remota, publicación de telemetría, almacenamiento, visualización, lógica local de decisión en las estaciones y actuación física sobre el sistema de riego.
...
El objetivo de esta fase del proyecto es desarrollar y validar una arquitectura funcional completa para riego inteligente, capaz de integrar sensorización ambiental, comunicación remota, almacenamiento de datos, visualización y actuación local sobre el riego. Por tanto, el trabajo se evalúa principalmente desde el punto de vista de la integración tecnológica, el funcionamiento del sistema y la validación mediante pruebas.
...
\begin{figure}[htbp]
    ...
    \caption{Delimitación del alcance del prototipo TierraViva y de los aspectos que quedan fuera de esta fase del trabajo. Elaboración propia, véase Anexo~\ref{sec:uso_ia_generativa_tfg}.}
...
Otra limitación relevante es la validación agronómica. Aunque el sistema está orientado al riego y se basa en variables relacionadas con el estado del entorno, no se ha realizado un ensayo prolongado durante varios meses sobre un cultivo real. Una validación de ese tipo requeriría controlar factores externos como el tipo de suelo, la especie cultivada, la climatología, la frecuencia de riego, la evolución del crecimiento de las plantas y la comparación con métodos tradicionales. En este TFG, la validación se centra en comprobar que el prototipo mide, comunica, registra, visualiza y actúa correctamente, dejando los ensayos agronómicos de larga duración como una posible línea futura. No obstante, el sistema sí se probó funcionalmente en un entorno real de cultivo en Agrolab Móstoles, donde se desplegó la estación B y se obtuvo realimentación cualitativa por parte de responsables y usuarios del espacio.
