...
Desde esta perspectiva, el proyecto se relaciona de forma directa con varios Objetivos de Desarrollo Sostenible. En primer lugar, se vincula con el ODS 2, especialmente con la meta 2.4 \cite{onu_ods2}, al plantear una herramienta tecnológica orientada a apoyar prácticas agrícolas más sostenibles y mejor adaptadas al estado real del entorno. También se relaciona con el ODS 6, en particular con la meta 6.4 \cite{onu_ods6}, ya que el riego basado en medidas de humedad del suelo puede contribuir a un uso más eficiente del agua frente a decisiones fijas o puramente manuales. De forma complementaria, TierraViva se alinea con el ODS 12, meta 12.2 \cite{onu_ods12}, al buscar un uso más eficiente de los recursos naturales, y con el ODS 13, meta 13.1 \cite{onu_ods13}, al favorecer sistemas agrícolas más observables y adaptables ante variaciones ambientales.

No obstante, esta contribución debe entenderse dentro del alcance real del TFG. TierraViva no demuestra por sí solo una mejora agronómica a largo plazo ni cuantifica todavía un ahorro de agua en explotación real, pero sí desarrolla una arquitectura técnica que permite medir, registrar, actuar de forma controlada y sentar las bases para futuras validaciones de impacto social y ambiental.
...
\begin{tabular}{|p{0.16\textwidth}|p{0.20\textwidth}|p{0.52\textwidth}|}
\hline
\rowcolor{URJCRed}
\TVHead{ODS} & \TVHead{Meta asociada} & \TVHead{Relación con TierraViva} \\
\hline
ODS 2: Hambre cero & Meta 2.4 & El proyecto se orienta a apoyar prácticas agrícolas más sostenibles mediante monitorización ambiental, decisión basada en datos y riego más ajustado al estado del suelo. \\
\hline
ODS 6: Agua limpia y saneamiento & Meta 6.4 & La medición de humedad del suelo y la actuación controlada permiten plantear un uso más eficiente del agua frente a riegos fijos o no informados. \\
\hline
ODS 12: Producción y consumo responsables & Meta 12.2 & El sistema busca reducir el uso innecesario de recursos mediante una gestión más informada del riego y una arquitectura reproducible de bajo coste relativo. \\
\hline
ODS 13: Acción por el clima & Meta 13.1 & La supervisión de variables ambientales y la trazabilidad de datos pueden favorecer sistemas agrícolas más adaptables ante cambios de temperatura, humedad o disponibilidad hídrica. \\
\hline
\end{tabular}

\caption{Relación entre TierraViva y los Objetivos de Desarrollo Sostenible.}
\label{tab:ods_tierraviva}
\end{table}

Por todo ello, este TFG no se plantea simplemente como un ejercicio académico más, sino como una oportunidad para construir una solución con valor real. La idea nace de una necesidad cercana, pero se plantea con una visión modular y escalable, de forma que pueda servir como base para futuras ampliaciones, como nuevas estaciones de campo, autonomía energética mediante panel solar o mecanismos predictivos basados en datos históricos.
...
Los Capítulos 5 y 6 se centran en la implementación del prototipo. El primero aborda la parte hardware y firmware de las estaciones, incluyendo la lectura de sensores, la publicación de telemetría y la decisión local de riego, mientras que el segundo describe la implementación software de supervisión en Raspberry Pi y nube. Posteriormente, el Capítulo 7 recoge la validación y las pruebas realizadas, y el Capítulo 8 analiza los resultados obtenidos, las limitaciones detectadas y la valoración del impacto social y ambiental del proyecto en relación con los ODS identificados.

Finalmente, el Capítulo 9 presenta las conclusiones del trabajo, el grado de cumplimiento del alcance planteado, las competencias aplicadas y adquiridas, y las posibles líneas de trabajo futuro.