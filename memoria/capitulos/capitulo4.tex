...
El cambio principal respecto a planteamientos anteriores es que la Raspberry Pi no actúa como cerebro del riego. La decisión crítica se desplaza al firmware de cada estación, que evalúa sus propias lecturas y aplica reglas locales de seguridad. La Raspberry conserva un papel importante, pero orientado a supervisión, histórico y visualización.
...
\hline
\texttt{field1} & Humedad del suelo (raw) & Valor bruto de humedad del sustrato utilizado por la estación para la decisión local de riego. \\
\hline
...
\hline
\texttt{field6} & Estado del relé & Estado del relé asociado al bloque de actuación: 0 para apagado y 1 para activo. \\
\hline
\texttt{field7} & Código de estado o evento & Código publicado por la estación para indicar funcionamiento normal, riego ejecutado, cooldown, error o modo seguro. \\
\hline
\texttt{field8} & Campo auxiliar & Campo reservado para depuración, diagnóstico o ampliaciones futuras. \\
\hline
\end{tabular}
